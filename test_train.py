...
linear_model = nn.models.Model_MLP([train_imgs.shape[-1], 600, 10], 'ReLU', lambda_list=[1e-5, 1e-5])
optimizer = nn.optimizer.MomentGD(init_lr=0.01, model=linear_model, mu=0.8)
